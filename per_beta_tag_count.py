...
for i in range(len(chr_list)):
    ...
    tag_bed['per_methyl']=(tag_bed['methyl_sum']+1)/(tag_bed['methyl_sum']+tag_bed['de_methyl_sum']+2)
    tag_bed['low']=beta.ppf(0.05,tag_bed['methyl_sum']+1,tag_bed['de_methyl_sum']+1)
